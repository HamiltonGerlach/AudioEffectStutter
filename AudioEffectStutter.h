...
#define PIN_POT3 17
#define PIN_POT4 22
const int PIN_POT[4] = {15, 16, 17, 18};
...
#define ANALOG_FILTER_FREQ 1.0f
...
#define ANALOG_GAIN_RECPR (1.0f / 32.0f)
#define ANALOG_MAX 1024
#define ANALOG_RESCALE (ANALOG_FILTER_PRESCALE / ANALOG_MAX)
#define ANALOG_OFFSET 16.0f
#define ANALOG_SNAP_THRESHOLD 0.00005f;
